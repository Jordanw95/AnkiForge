...
body {
	...
	<div class=learnt>
		{{Learnt}}
                ...
                {
                    'name': 'Card 3',
                    'qfmt':  """<div class = answer-background>
	<div class=container-front id=container-back>
		<div class= native-front id=native-front>
			{{Learnt}}
		</div>
		<div class = audiobutton>
...
class PrettyStandardModelTextBothSides():
    model_name = 'Pretty Standard Model Text Both Sides(with reverse)'
    css =""".card {
font-family:Avantgarde, TeX Gyre Adventor, URW Gothic L, sans-serif;
font-size: 24px;
text-align: center;
